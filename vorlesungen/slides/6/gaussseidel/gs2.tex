...
\[
\begin{linsys}{6}
{\color{red}\hbox{$-698.18$}}&=&\s\displaystyle\frac{1}{1}\cdot\bigl(4& &             &-&\s 1\cdot(\phantom{+}194.59)&-&\s 0\cdot(\hbox{$-206.16$})&-&\s 1\cdot(\phantom{+}507.59)\bigr)\\
{\color{red}\phantom{+}453.17}&=&\s\displaystyle\frac{1}{2}\cdot\bigl(2&-&\s 1\cdot({\color{red}\hbox{$-698.18$}})& &             &-&\s 1\cdot(\hbox{$-206.16$})&-&\s 0\cdot(\phantom{+}507.59)\bigr)\\
{\color{red}\hbox{$-479.88$}}&=&\s\displaystyle\frac{1}{2}\cdot\bigl(1&-&\s 0\cdot({\color{red}\hbox{$-698.18$}})&-&\s 1\cdot({\color{red}\phantom{+}453.17})& &             &-&\s 1\cdot(\phantom{+}507.59)\bigr)\\
{\color{red}\phantom{+}1181.06}&=&\s\displaystyle\frac{1}{1}\cdot\bigl(3&-&\s 1\cdot({\color{red}\hbox{$-698.18$}})&-&\s 0\cdot({\color{red}\phantom{+}453.17})&-&\s 1\cdot({\color{red}\hbox{$-479.88$}})& &             \bigr)\\
\end{linsys}
\]
}
\only<10>{
...
\[
\begin{linsys}{6}
{\color{red}\hbox{$-1630.23$}}&=&\s\displaystyle\frac{1}{1}\cdot\bigl(4& &             &-&\s 1\cdot(\phantom{+}453.17)&-&\s 0\cdot(\hbox{$-479.88$})&-&\s 1\cdot(\phantom{+}1181.06)\bigr)\\
{\color{red}\phantom{+}1056.05}&=&\s\displaystyle\frac{1}{2}\cdot\bigl(2&-&\s 1\cdot({\color{red}\hbox{$-1630.23$}})& &             &-&\s 1\cdot(\hbox{$-479.88$})&-&\s 0\cdot(\phantom{+}1181.06)\bigr)\\
{\color{red}\hbox{$-1118.06$}}&=&\s\displaystyle\frac{1}{2}\cdot\bigl(1&-&\s 0\cdot({\color{red}\hbox{$-1630.23$}})&-&\s 1\cdot({\color{red}\phantom{+}1056.05})& &             &-&\s 1\cdot(\phantom{+}1181.06)\bigr)\\
{\color{red}\phantom{+}2751.29}&=&\s\displaystyle\frac{1}{1}\cdot\bigl(3&-&\s 1\cdot({\color{red}\hbox{$-1630.23$}})&-&\s 0\cdot({\color{red}\phantom{+}1056.05})&-&\s 1\cdot({\color{red}\hbox{$-1118.06$}})& &             \bigr)\\
\end{linsys}
\]
}
\only<11>{
...
\[
\begin{linsys}{6}
{\color{red}\hbox{$-3803.34$}}&=&\s\displaystyle\frac{1}{1}\cdot\bigl(4& &             &-&\s 1\cdot(\phantom{+}1056.05)&-&\s 0\cdot(\hbox{$-1118.06$})&-&\s 1\cdot(\phantom{+}2751.29)\bigr)\\
{\color{red}\phantom{+}2461.70}&=&\s\displaystyle\frac{1}{2}\cdot\bigl(2&-&\s 1\cdot({\color{red}\hbox{$-3803.34$}})& &             &-&\s 1\cdot(\hbox{$-1118.06$})&-&\s 0\cdot(\phantom{+}2751.29)\bigr)\\
{\color{red}\hbox{$-2605.99$}}&=&\s\displaystyle\frac{1}{2}\cdot\bigl(1&-&\s 0\cdot({\color{red}\hbox{$-3803.34$}})&-&\s 1\cdot({\color{red}\phantom{+}2461.70})& &             &-&\s 1\cdot(\phantom{+}2751.29)\bigr)\\
{\color{red}\phantom{+}6412.33}&=&\s\displaystyle\frac{1}{1}\cdot\bigl(3&-&\s 1\cdot({\color{red}\hbox{$-3803.34$}})&-&\s 0\cdot({\color{red}\phantom{+}2461.70})&-&\s 1\cdot({\color{red}\hbox{$-2605.99$}})& &             \bigr)\\
\end{linsys}
\]
}
