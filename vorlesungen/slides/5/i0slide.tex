...
den Lockdown hintersich bringen
\medskip

$\Rightarrow$ Kapaztitäten ausbauen

\end{block}}
\uncover<3->{
\begin{block}{$\gamma$-Abhängigkeit}
Je schneller die Genesung $\color{red}\gamma$, desto desto schneller wird die
...
\uncover<2->{
\node[color=blue] at ({10-0.2},6.8) [right] {$I_0=0.2$};
\node[color=blue] at ({10-0.2},2.7) [right] {$I_0=0.1$};
}
