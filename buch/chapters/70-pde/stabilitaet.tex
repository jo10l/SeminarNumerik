...
\[
y'(x_i) \simeq \frac{y_{i+1}-y_i}{h} = -y(x_i) = -y_i
...
\]
approximieren.
Der $x$-Wert, bei dem der Computational Mode überhand nimmt ist
daher
\[
...
In Abbildung~\ref{buch:pde:cm:fig} ist der Betrag der Lösung gezeigt
für verschiedene Schrittweiten $h$.
