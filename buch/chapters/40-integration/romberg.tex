...
\subsubsection{Elminiation des Fehlers}
...
I&=T^*(h) + Ch^4 \\
 &=T^*(h/2) + C\frac{h^4}{16}
\end{align*}
mit $16$ und subrahieren die erste, so erhalten wir
\[
15I = 16T^*(h/2)-T(h)
\qquad\Rightarrow\qquad
...
$k=9$, als mit nur $513$ Funktionsauswertungen ermöglicht.
