...
%\subsubsection{Jordan-Blockmatrizen mit gleichem $\lambda$}
%Setzt man mehrer Jordan-Blöcke in eine Blockmatrix der Form
%\[
%A
%=
%\begin{pmatrix}
...
%\end{pmatrix},
%\]
%dann hat jeder einzelne Block den Spektralradius
%$\pi(J_{n_i}(\lambda)=|\lambda|$.
%Es folgt aus Lemma~\ref{buch:spektralradius::lemma:diagonalbloecke},
%dass der Spektralradius $ \pi(A) = |\lambda| $ ist.
%
%\subsubsection{Allgemeiner Fall}
%In der linearen Algebra lernt man, dass sich jede Matrix schreiben
%lässt als eine Blockmatrix 
%mit Blöcke der Form~\eqref{buch:spektralradius:eqn:jordan}
%auf der Diagonalen.
%Da jeder einzelne dieser Blöcke Spektralradius $|\lambda|$ hat,
%folgt wieder mit Lemma~\ref{buch:spektralradius:lemma:diagonalbloecke},
%dass der Spektralradius der Betrag des betragsgrössten Eigenwertes ist.
%Damit haben wir folgenden Satz bewiesen.
%
%\begin{satz}
%Sei $A$ eine $n\times n$-Matrix, mit betragsgrösstem Eigenwert
%$\lambda_1$.
%Dann ist der Spektralradius
%\[
%\varrho(A) = \lim_{k\to\infty} \|A^k\|^\frac1k = |\lambda_1|.
%\]
%\end{satz}
