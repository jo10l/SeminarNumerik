...
\begin{align}
    ...
    = 0.
\end{align}
Falls $i, j$ entartet sind, geht die Gleichung auf. Wir können also Formel \ref{ew:eq:explicit_eigvecs} auch für entartete Eigenwerte brauchen, falls %TODO ref
\begin{equation}
