...
\begin{tikzpicture}
  ...
  \draw [->] (3) to [out=210,in=-30]node[anchor=north]{\small $\frac{\partial u}{2\partial x}$} (4);
  \draw [->] (1) to [out=240,in=120]node[anchor=east]{\small $\frac{\partial u}{\partial t}$} (5) ;
