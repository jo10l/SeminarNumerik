...
\subsubsection{Lineare Methoden}
	...
	\begin{equation}
        ...
        umgeschrieben werden.
	  	Für die Lösung muss \eqref{burgers:eq_ex_lin1} nach $ u_{i}^{n}$
...
\medskip
	...
	\end{equation}
	 nur minimal ändert.
	 Auch kann wieder eine Lösung für den gesuchten Punkt $u_{i}^{n}$ 
...
\medskip
	...
	Die Diskretisierung \"anderst sich zu
...
\subsubsection{Quadratisch}
	...
	oder in Matrixform
	  \begin{equation}
	    ...
	    \end{bmatrix}
	  \end{equation}
	   und k\"onnen mit dem Thomas Algorithmus \autoref{TDMA} mit der Geschwindigkeit $O(n)$ gel\"ost werden.
	   Mehr zum Algorithmus im \autoref{buch:subsection:thomasalgorithmus}.
	...
	Mehr dazu im \autoref{pde:subsection:stabilitaet}
