...
Das Kaptiel \autoref{chapter:pde} beschreibt den theoretischen Aspekt der Numerik  partieller Differentialgleichungen.
...
\subsubsection{Lineare Methoden}
	...
	Die grundlegende  \autoref{burgers:eq_invisid_burgers} kann mit der gewählten Methode
	\begin{equation}
        ...
        umgeschrieben werden.
	  	Für die Lösung muss die \autoref{burgers:eq_ex_lin1} nach
...
\subsubsection{Stabilit\"atskriterium Leap-Frog Verfahren}
	...
	Die erw\"ahte Instabilit\"at im Abschnitt \ref{burgers:sec:nwp} auf welche Richardson gestossen ist, ist dieselbe welche hier beschrieben wird.
...
\begin{subequations}
	...
	Allerdings ist 	$|\alpha_-| > 1$ und damit w\"achst die \autoref{burgers:eq_cm} ohne Limit mit $n$.
	...
	wird in dieser Anwendung allerdings nicht auf die Zeit, sonder auf die Raum-Dom\"ane angewendet.
