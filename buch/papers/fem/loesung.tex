...
\end{figure}
Nun ist das Flächenelement $dx \, dy$ mit Hilfe der Jacobi Determinante \eqref{fem:JocobiDeterminante} der Transformation zu ersetzen durch \eqref{fem:newTransformation}.
...
\begin{equation}
			\int_{\triangle} u \quad dy \, dx = \int_0^1 \int_0^{1 - \xi} \, ... \, d \eta \, d \xi
\end{equation}
