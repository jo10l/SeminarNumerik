...
\begin{figure}[h]
	\centering
	\input{papers/fem/Images/dreiecke.tex}
...
\begin{equation}
\int_{\triangle_1} \underbrace{c_1^2}_{\textcolor{red}{\frac{1}{2}}} + \underbrace{c_2^2 x^2}_{\textcolor{red}{\frac{1}{12}}} + \underbrace{c_4^2 y^2}_{\textcolor{red}{\frac{1}{12}}} + \underbrace{2 c_1 c_2 x}_{\textcolor{red}{\frac{1}{6}}} + \underbrace{2 c_1 c_4 y}_{\textcolor{red}{\frac{1}{3}}} + \underbrace{2 c_2 c_4}_{\textcolor{red}{\frac{1}{24}}} d\eta \; d\xi
\end{equation}
und von $\textcolor{blue}{\triangle_2}$ 
\begin{equation}
\int_{\triangle_2} \underbrace{c_2^2}_{\textcolor{blue}{\frac{1}{2}}} + \underbrace{c_3^2 x^2}_{\textcolor{blue}{\frac{1}{12}}} + \underbrace{c_4^2 y^2}_{\textcolor{blue}{\frac{1}{12}}} + \underbrace{2 c_2 c_3 x}_{\textcolor{blue}{\frac{1}{6}}} + \underbrace{2 c_2 c_4 y}_{\textcolor{blue}{\frac{1}{3}}} + \underbrace{2 c_3 c_4}_{\textcolor{blue}{\frac{1}{24}}} d\eta \; d\xi \; .
\end{equation}
Die Koeffizienten der jeweiligen Gebiete werden gemäss der Abbildung \ref{fem:MatrixBKomplett} zusammengesetzt.
\begin{figure}[h]
	\centering
	\input{papers/fem/Images/matrizen.tex}
	\caption{Matrix $B$ zusammenstellen }
	\label{fem:MatrixBKomplett}
\end{figure}
Das Vorgehen für die Matrix $A$ ist genau gleich. Zu beachten ist allerdings dass beim Zusammensetzen die $\tilde{c}$- Variablen verwendet werden müssen. Die Umrechnung ist im Abschnitt \ref{fem:section:loesungTrans} beschrieben. 
Wie sieht die Matrix aus wenn mit mehr Dreiecken approximiert wird? Bei einem 5x5 Gitter mit 36 Variablen hätte die Matrix $B$ die Form wie in Abbildung \ref{fem:MatrixBGross} .

\begin{figure}[h]
	\centering
	\input{papers/fem/Images/gross.tex}
	\caption{5x5 Gitter}
