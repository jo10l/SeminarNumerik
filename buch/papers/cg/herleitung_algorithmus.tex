...
Die Idee des CG-Algorithmus ist es, die Schwächen von Gradient Descent auszubessern.
...
In der Summe von \ref{cg:eq:gram} wird daher nur der letzte Term benötigt.
