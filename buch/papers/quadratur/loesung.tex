...
\begin{align}
    A_{0}\phantom{x^{0}} + A{1}\phantom{x^{0}} &= 0 \\
    A_{0}x_{0} + A{1}x_{1} &= \frac{2}{3} \approx 0.66667 \\
    A_{0}x_{0}^{2} + A{1}x_{1}^{2} &= 0 \\
    A_{0}x_{0}^{3} + A{1}x_{1}^{3} &= \frac{2}{5} = 0.4
\end{align}
daraus ergibt sich die Lösung
\begin{align}
    A_{0} &= \phantom{-}\frac{\sqrt{\frac{5}{3}}}{3} & x_{0} &= \phantom{-}\sqrt{\frac{3}{5}} & \\
    A_{1} &= -\frac{\sqrt{\frac{5}{3}}}{3} & x_{1} &= -\sqrt{\frac{3}{5}} &
\end{align}
...
\textcolor{red}{
    ...
    \begin{itemize}
        ...
        \item Fehler der Gauss-Quadratur (Beispiel: Fehler nochmals durchrechnen. Referenzbeispiel hatte 0.008)
        \item Korrekturlesen mit zwei weiteren quellen
    \end{itemize}
}
