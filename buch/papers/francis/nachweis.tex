...
\lstinputlisting[language=Matlab, style=Python, firstline=1, lastline=6,caption={},label={francis:codes:code1}]{papers/francis/codes/code.m}
Anschliessend soll der Wilkinson-Shift berechnet werden.
Dies geschieht im folgenden Code-Abschnitt.
\lstinputlisting[language=Matlab, style=Python, firstline=7, lastline=21,caption={},label={francis:codes:code2}]{papers/francis/codes/code.m}
...
\lstinputlisting[language=Matlab, style=Python, firstline=22, lastline=27,caption={},label={francis:codes:code3}]{papers/francis/codes/code.m}
...
\lstinputlisting[language=Matlab, style=Python, firstline=28, lastline=40,caption={},label={francis:codes:code4}]{papers/francis/codes/code.m}
Zum Schluss kann man die wichtigsten Matrixelemente ausgeben.
\lstinputlisting[language=Matlab, style=Python, firstline=41, lastline=44,caption={},label={francis:codes:code5}]{papers/francis/codes/code.m}
