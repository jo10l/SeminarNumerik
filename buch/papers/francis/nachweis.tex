...
\lstinputlisting[language=Matlab, style=Python, firstline=7, lastline=23,caption={},label={francis:codes:code2}]{papers/francis/codes/code.m}
...
\lstinputlisting[language=Matlab, style=Python, firstline=24, lastline=29,caption={},label={francis:codes:code3}]{papers/francis/codes/code.m}
...
\lstinputlisting[language=Matlab, style=Python, firstline=30, lastline=42,caption={},label={francis:codes:code4}]{papers/francis/codes/code.m}
Zum Schluss kann man die wichtigsten Matrixelemente ausgeben.
\lstinputlisting[language=Matlab, style=Python, firstline=43, lastline=46,caption={},label={francis:codes:code5}]{papers/francis/codes/code.m}
