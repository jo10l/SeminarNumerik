...
\end{equation}
Unter der Annahme, dass die Spannung $U_{\text{in}}$ eine über die Zeit unveränderliche Grösse ist, d.h. $U_{\text{in}}(t) = U_0$, die beiden Seiten der Gleichung \ref{vanderpol:equations:kirchoff} wird nach $t$ abgeleitet:
...
\end{equation*}
die sogenannte {\em angeregte Van der Pol Gleichung} wird daher erhalten, wenn $f(x) = A \sin(\omega t)$ gesetzt wird:
\begin{equation}
