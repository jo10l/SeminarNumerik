...
plt.plot([i[0][0] for i in pMo], [i[0][1] for i in pMo], '--', color='#1f77b4', label=f'h=0.01s, ({len(pMo)} Samples)')
t, pMo=rk.rk_system_nd_ssc_single_test_step(0, [pMo0_0, vMo0_0], 4.5, a_p, 0.05, 0.05, 5)
plt.plot([i[0][0] for i in pMo], [i[0][1] for i in pMo], '--', color='#17becf', label=f'h=0.05s, ({len(pMo)} Samples)')
t, pMo=rk.rk_system_nd_ssc_single_test_step(0, [pMo0_0, vMo0_0], 4.5, a_p, 0.1, 0.1, 5)
plt.plot([i[0][0] for i in pMo], [i[0][1] for i in pMo], '--', color='#ff7f0e', label=f'h=0.1s, ({len(pMo)} Samples)')
t, pMo=rk_system_nd_ssc_single_test_step(0, [pMo0_0, vMo0_0], 4.5, a_p, 0.01, 2, 4)
plt.plot([i[0][0] for i in pMo], [i[0][1] for i in pMo], '.-', color='#d62728', label=f'h=0.01s ... 2s, ({len(pMo)} Samples)')
